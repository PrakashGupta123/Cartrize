...
//- (id)initWithFrame:(CGRect)frame andRating:(int)rating withLabel:(BOOL)label animated:(BOOL)animated
{
    ...
    if (self)
    {
        ...
        starBackground.contents = (__bridge id)([UIImage imageNamed:@"rating_zero.png"].CGImage);
        ...
        {
            [tintLayer setBackgroundColor:[UIColor colorWithRed:99.0f/255.0f green:171.0f/255.0f blue:159.0f/255.0f alpha:1.0].CGColor];
        }
        else
        {
            [tintLayer setBackgroundColor:[UIColor colorWithRed:99.0f/255.0f green:171.0f/255.0f blue:159.0f/255.0f alpha:1.0].CGColor];
        ...
        starMask.contents = (__bridge id)([UIImage imageNamed:@"rating_zero.png"].CGImage);
...
- (id)initWithFrame:(CGRect)frame andRating:(int)rating withLabel:(BOOL)label animated:(BOOL)animated withSetRating:(BOOL)giveRating
{
    ...
    if (self)
        ...
        if (self.userRating >=20.0f)
            {
            [tintLayer setBackgroundColor:[UIColor colorWithRed:17.0f/255.0f green:189.0f/255.0f blue:207.0f/255.0f alpha:1.0].CGColor];
            }
        else
            {
            [tintLayer setBackgroundColor:[UIColor colorWithRed:17.0f/255.0f green:189.0f/255.0f blue:207.0f/255.0f alpha:1.0].CGColor];
...
-(void)ratingDidChange
{
    if(isGiveRating)
        ...
        if (self.userRating < 20.0f)
            {
            [self.tintLayer setBackgroundColor:[UIColor colorWithRed:17.0f/255.0f green:189.0f/255.0f blue:207.0f/255.0f alpha:1.0].CGColor];
...
-(void)SaveTableUpdates
{
    if([_delegate respondsToSelector:@selector(onTapTableWidgetSaveUpdates:)])
        [_delegate onTapTableWidgetSaveUpdates:self];
}
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
        //if ([[NSUserDefaults standardUserDefaults]boolForKey:@"isUserLogin"])
    {
        if (CGRectContainsPoint(self.bounds, [[[touches allObjects]lastObject] locationInView:self]))
        {
            ...
            [self SaveTableUpdates];
        }
    }
//    else
//    {
//        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"Please Login to Rate." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
//        [alert show];
//    }
}
