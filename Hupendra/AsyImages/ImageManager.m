...
- (id)init
{
    ...
    if (self)
	{
		...
		documentsDirectory = [[paths objectAtIndex:0] stringByAppendingString:imageCacheFolder] ;
        
        paths = NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES);
		cacheDirectory =  [[paths objectAtIndex:0] stringByAppendingString:imageCacheFolder] ;
